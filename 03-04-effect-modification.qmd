...
Effect modification estimands inherit exchangeability, positivity, and consistency. Additionally, moderator variables must be **measured before treatment**, and you should avoid conditioning on post-treatment variables.
...
**Definition.** Causal forests are tree-based methods designed to estimate CATEs --- “smart subgroup finders” that search across covariates for splits maximizing treatment-effect heterogeneity. They use honest sample splitting and averaging across many trees to produce smooth, individual-level CATE estimates $\hat\tau(x)$ with approximate pointwise confidence intervals.
:::
