...
The initial outcome and propensity score models do not have to be simple GLMs. They can be estimated with Super Learner [@vanderLaan2007superlearner], an ensemble machine learning approach covered in the next chapter, which reduces sensitivity to model misspecification.
