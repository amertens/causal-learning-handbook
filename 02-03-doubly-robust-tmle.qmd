...
This chapter presented the theory and mechanics of AIPW and TMLE. The next chapter puts everything together in a single progressive tutorial: starting from a naive analysis and building up to a full TMLE implementation on the same dataset, with diagnostics at every step.
