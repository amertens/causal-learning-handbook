...
3. It integrates naturally with ensemble machine learning (Super Learner), and CV-TMLE provides valid inference under regularity conditions even when nuisances are estimated with flexible learners [@zheng2011crossvalidated]
...
The initial outcome and propensity score models do not have to be simple GLMs. They can be estimated with Super Learner, an ensemble machine learning approach covered in the next chapter, which reduces sensitivity to model misspecification.
...
| Integration with Super Learner | Works with cross-fitting (DML-style) | Designed alongside Super Learner; CV-TMLE is the standard recipe |
