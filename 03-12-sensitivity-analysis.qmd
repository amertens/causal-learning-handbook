...
*This chapter complements [Chapter 3.5](03-05-advanced-diagnostics.qmd), which introduces E-values, quantitative bias analysis, and other sensitivity tools within a broader diagnostic framework. Here we provide the detailed worked implementations --- complete R code for E-value computation, probabilistic QBA with `episensr`, truncation sensitivity, negative control outcomes, and learner library sensitivity --- so you can apply these tools in practice.*
