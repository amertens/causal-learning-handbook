...
Unmeasured confounding is a key concern for the HAART cohort. Although sex, age, and baseline CD4 count are measured, important confounders such as medication adherence, WHO clinical staging, and socioeconomic factors are not captured. These variables plausibly influence both the decision to initiate HAART and the risk of death, potentially biasing estimated treatment effects.
...
In this setting, adherence is a particularly plausible unmeasured confounder: patients who adhere to HAART are likely healthier and more engaged with care, inflating the apparent benefit. Quantitative bias analysis using literature-based adherence parameters (as shown in Section 4) can bound this bias.
