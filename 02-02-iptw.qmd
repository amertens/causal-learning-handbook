...
We use the shared osteoporosis cohort from `_data/sim-osteoporosis-cohort.R`, the same simulated dataset used throughout the handbook: denosumab (A=1) vs zoledronic acid (A=0) for 3-year MI risk, with confounding by age and cardiovascular history.
