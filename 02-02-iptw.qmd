...
Under the same identification assumptions from [Chapter 1.3](01-03-identification-estimands.qmd) (consistency, exchangeability, and positivity), the average potential outcome under treatment can be expressed as
...
**NOTE: the plot above shows good overlap, note this below**
...
**NOTE: can you briefly define in plain english what the marginal probability of treatment is?**
...
**NOTE: can you provide a brief (1 sentence) example when one would prefer unstabalized weights**
...
**NOTE: can you describe how we'd get confidence intervals out of the method above? Bootstrapped CIs?**
...
**NOTE: can you describe when and why they would differ?**
...
**NOTE: note above that the later chapter will show how simulations can be used to choose appropriate truncations for specific data examples**
