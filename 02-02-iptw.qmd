...
G-computation depends on the outcome model. IPTW depends on the treatment model. What if you could use both, and be protected if either one is wrong? The next chapter introduces doubly robust estimators, including AIPW and TMLE, that provide exactly this insurance.
