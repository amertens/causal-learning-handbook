...
**G-computation** depends on correctly specifying the **outcome model** $E[Y \mid A, W]$, and **IPTW** depends on correctly specifying the **treatment model** $P(A \mid W)$. Neither uses both models at once. This motivates **doubly robust** methods (next chapter), which provide consistent estimates if *either* model is correctly specified. When IPTW and g-computation give very different answers, at least one model may be misspecified.
