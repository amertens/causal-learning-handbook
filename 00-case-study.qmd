...
The target trial protocol, causal DAGs (both the simplified point-treatment version and the full longitudinal structure with treatment-confounder feedback), and identification assumptions for this case study are developed in detail in [Chapter 1.2: The Causal Roadmap](01-02-causal-roadmap.qmd), where each step of the roadmap is applied to this HAART example.
