...
The dataset is distributed as `haartdat` in the `ipw` R package. It is a *simulated* cohort (not a prospective study) built to reproduce the structure of real HIV cohorts used in the marginal structural model literature. It contains 1,200 HIV-positive patients observed from HIV seroconversion in person-period (long) format, with one row per patient per fixed 100-day interval. The regular interval grid is a feature of the simulation; in real-world data, visit times would be irregular and would themselves need to be modeled.
