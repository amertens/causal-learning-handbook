...
Positivity violations are diagnosed using propensity score overlap plots and effective sample size calculations. We cover this in detail in [Chapter 3.2](03-02-positivity-overlap.qmd).
...
The main estimation approaches covered in this handbook are g-computation ([Chapter 2.1](02-01-gcomputation.qmd)), which models the outcome and standardizes; IPTW ([Chapter 2.2](02-02-iptw.qmd)), which reweights by inverse probability of treatment; and TMLE ([Chapter 2.3](02-03-doubly-robust-tmle.qmd)), which combines both for double robustness. For longitudinal settings with time-varying confounding, these extend to longitudinal TMLE ([Chapter 3.9](03-09-illustrated-ltmle.qmd)).
...
We cover sensitivity analysis tools in [Chapter 3.12](03-12-sensitivity-analysis.qmd) and diagnostic frameworks in [Chapter 3.5](03-05-advanced-diagnostics.qmd).
...
For most readers of this handbook, the practical implication is modest: write the Causal Roadmap down (a one- to two-page analysis plan covering Steps 1–6 plus pre-specified diagnostic and adaptation rules), version-control it, and date-stamp it before pulling the outcome. The longer the gap between locking the plan and seeing the outcome, the more credible the resulting estimate. Chapters [3.5](03-05-advanced-diagnostics.qmd) and [3.6](03-06-rwd-meets-rct-hybrid-designs.qmd) revisit the clean-room idea in the contexts of diagnostic-driven adaptation and hybrid RCT–RWD designs, where the staging is most heavily formalized.
...
**Step 6: Sensitivity analysis.** E-values for unmeasured confounding (Chapter 3.12), negative control outcomes, and assessment of informative censoring are needed before drawing causal conclusions.

**Step 7: Interpretation.** Diagnostics (Chapter 3.5) and the sensitivity analyses from Step 6 inform the credibility of the final estimate. Results should be interpreted in light of the plausibility of sequential exchangeability and positivity in the specific data source.
