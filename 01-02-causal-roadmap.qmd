...
(Cite Dang and Balzer)

A useful way to begin the roadmap is to first sketch the **target trial protocol**. This does not mean every observational study literally recreates a randomized trial. It means we use the trial protocol as a design device to make the causal question precise before we choose an estimator.
