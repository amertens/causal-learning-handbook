...
G-computation depends entirely on the outcome model being correctly specified. What if we could instead model the treatment mechanism? The next chapter introduces IPTW, which takes exactly that approach, creating a pseudo-population where treatment appears randomized.
