...
If you have been reading this book from the beginning, you now have a rich toolkit: DAGs for encoding assumptions ([Chapter 1.2](01-02-causal-roadmap.qmd)), formal estimands for pinning down what you want to estimate, G-computation ([Chapter 2.1](02-01-gcomputation.qmd)), IPTW ([Chapter 2.2](02-02-iptw.qmd)), TMLE ([Chapter 2.3](02-03-doubly-robust-tmle.qmd)), and Super Learner for flexible nuisance estimation ([Chapter 2.5](02-05-superlearner.qmd)). Each chapter taught one piece of the puzzle. This chapter synthesizes those methods into a complete analysis workflow, and previews the diagnostic and sensitivity analysis tools covered in the chapters that follow.
...
|------|--------|-------------|
| 1 | Define the causal question and target trial | [Chapter 1.2](01-02-causal-roadmap.qmd) |
| 2 | Specify the estimand | [Chapter 1.2](01-02-causal-roadmap.qmd) |
| 3 | Draw the DAG | [Chapter 1.2](01-02-causal-roadmap.qmd) |
| 4 | State the identification assumptions | [Chapter 1.2](01-02-causal-roadmap.qmd) |
| 4b | **Assess data suitability** | [Chapter 1.3](01-03-rwe-protocols-reporting-audit.qmd) |
| 5 | Check overlap and data support | [Chapter 3.2](03-02-positivity-overlap.qmd) |
| 6 | Choose the estimator | [Chapters 2.1--2.3](02-01-gcomputation.qmd) |
| 7 | Fit nuisance models with Super Learner | [Chapter 2.5](02-05-superlearner.qmd) |
| 8 | Estimate the causal effect | [Chapter 2.3](02-03-doubly-robust-tmle.qmd) |
| 9 | Run diagnostics | [Chapter 3.5](03-05-advanced-diagnostics.qmd) |
| 10 | Run sensitivity analyses | [Chapter 3.12](03-12-sensitivity-analysis.qmd) |
| 11 | Interpret the result for the target population | [Chapter 1.2](01-02-causal-roadmap.qmd) |
| 12 | **Document and report** | [Chapter 1.3](01-03-rwe-protocols-reporting-audit.qmd) |
