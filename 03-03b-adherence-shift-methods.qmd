...
L-TMLE and LMTP are complementary tools for longitudinal causal inference. L-TMLE targets static or dynamic regimes (set $A_t$ to a specific value). LMTP targets modified treatment policies where the intervention depends on the patient's natural treatment value. LMTP can also estimate static interventions as a special case, but its primary advantage is the ability to define realistic shifts that respect the data support.
...
| Survival outcomes | Yes | Yes |
| Censoring adjustment | Yes | Yes |

For the conceptual treatment of how L-TMLE works, see the [L-TMLE concepts chapter](03-09-illustrated-ltmle.qmd). For a full by-hand implementation, see the [technical companion](03-09b-ltmle-by-hand.qmd).
