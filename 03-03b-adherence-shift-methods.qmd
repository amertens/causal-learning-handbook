...
The crude curves overestimate the adherence effect because they compare patients who are not exchangeable. The causal adherence-response curve (the forgiveness curve) requires g-methods that account for the feedback between adherence and health. The L-TMLE chapter (@sec-illustrated-ltmle) showed how to estimate static adherence regimes; here we focus on the feasible shift approach using LMTP.
