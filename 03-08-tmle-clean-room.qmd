...
The FDA guidance on externally controlled trials [@fda2023external] and the FDA guidance on assessing EHR and claims data [@fda2024ehr] emphasize that the analysis must be reproducible by an independent reviewer given the same data and code. The clean-room workflow facilitates this by separating pre-specification (Phase 1) from execution (Phase 3), creating a natural audit boundary. For structured reporting templates, see [Chapter 1.3](01-03-rwe-protocols-reporting-audit.qmd).
:::
