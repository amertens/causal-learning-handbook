...
In regulatory submissions, the FDA expects that RWE studies document data provenance, cohort selection rationale, variable definitions, and analysis code in sufficient detail for independent reproduction [@fda2018rwe; @fda2023external]. See [Chapter 3.8](03-08-tmle-clean-room.qmd) for the clean-room workflow and audit trail requirements.
