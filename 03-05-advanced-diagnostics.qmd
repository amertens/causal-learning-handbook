...
Every TMLE or AIPW analysis rests on identification assumptions (see [Chapter 1.3](01-03-identification-estimands.qmd)), nuisance model estimation, and the statistical behavior of the estimator itself. Diagnostics check each layer. This chapter organizes them into four practical categories:
