...
For detailed templates and fillable tables, see [Chapter 1.3: Protocols, Reporting Standards, and Auditability](01-03-rwe-protocols-reporting-audit.qmd). In regulatory submissions, the FDA expects that RWE studies document data provenance, cohort selection rationale, variable definitions, and analysis code in sufficient detail for independent reproduction [@fda2018rwe; @fda2023external].
